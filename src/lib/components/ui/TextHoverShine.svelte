<script lang="ts">
  ...
  >
    ...
    <text
      ...
      stroke-width="0.3"
      class="font-[helvetica] transition-all duration-200 font-bold stroke-neutral-700 dark:stroke-neutral-800 fill-transparent text-5xl"
    ...
    <text
      ...
      dominant-baseline="middle"
      stroke-width="0.3"
      class="font-[helvetica] font-bold fill-transparent text-5xl stroke-neutral-500/55 dark:stroke-neutral-700/60"
    >
      {text}
    </text>
    <text
