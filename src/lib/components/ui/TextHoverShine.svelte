...
>
	...
	<text
		...
		stroke-width="0.3"
		class="fill-transparent stroke-neutral-700 font-[helvetica] text-5xl font-bold transition-all duration-200 dark:stroke-neutral-800"
	...
	<text
		...
		dominant-baseline="middle"
		stroke-width="0.3"
		class="fill-transparent stroke-neutral-500/55 font-[helvetica] text-5xl font-bold dark:stroke-neutral-700/60"
	>
		{text}
	</text>
	<text
