...
<div class="p-6 text-slate-300 rounded-lg shadow-xl">
    <div class="text-3xl font-extrabold text-center">
        LeetCode Stats
    </div>
    <div class="text-center text-slate-600 text-lg font-semibold mt-2">
        Username: <span class="text-slate-300">Tahmid019</span>
    </div>

    <div class="mt-6 flex flex-col lg:flex-row items-center justify-center gap-6">
        <!-- Progress Bars -->
            ...
            <div class="space-y-4">
                <div class="relative w-full">
                    ...
                    <div class="w-full bg-gray-700 rounded-lg h-2">
                        <div class="h-2 rounded-lg bg-green-500 transition-all duration-500 ease-in-out"
                ...
                <div class="relative w-full">
                    ...
                    <div class="w-full bg-gray-700 rounded-lg h-2">
                        <div class="h-2 rounded-lg bg-yellow-500 transition-all duration-500 ease-in-out"
                ...
                <div class="relative w-full">
                    ...
                    <div class="w-full bg-gray-700 rounded-lg h-2">
                        <div class="h-2 rounded-lg bg-red-500 transition-all duration-500 ease-in-out"
        ...
        <div class="relative w-40 h-40 flex items-center justify-center">
            <svg class="w-full h-full" viewBox="0 0 160 160">
                ...
                <!-- Progress Circle -->
                <circle cx="80" cy="80" r="70" stroke="url(#gradient)" stroke-width="10" fill="none" 
            ...
            <div class="absolute flex flex-col items-center text-lg font-bold">
                ...
                <span class="text-gray-300 text-sm">Acceptance Rate</span>
            </div>
        </div>
    </div>
</div>
